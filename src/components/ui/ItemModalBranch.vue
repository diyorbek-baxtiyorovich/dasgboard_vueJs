    ...
    <div v-if="isModalOpen" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <input type="text" v-model="localBranch.city" class="form-control" placeholder="Filial nomini kiriting">
            </div>

            <div class="form-group">
                <label>MFO</label>
                <input type="text" v-model="localBranch.MFO" class="form-control" placeholder="MFO kiriting">
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-success" @click="handleSubmit">{{ isEditing ? "Update" : "Save" }}</button>
